...
df = pd.read_excel (r'C:\Users\ACHANG\Desktop\Swinburne Research\(2-2) Statistcs -MCF10A\20220214 MCF10A PLA\Ec-Px.xlsx',
                    sheet_name='T')
...
sns.violinplot(x=["xxx"]*len(df), y='Value',  # please indicate the x = ["type what you want to indicate"]
              data=df, cut=0.4, bw=0.5, 
              scale='count', 
              hue='Type', split=True, showcaps=False,
              palette=['limegreen','lightgray'], linecolor= 'k',
              inner='quartile')
...
ax.yaxis.set_tick_params(labelsize=30, length =0)